...
public interface SqlConstant {
	...
	public static final String LOAD_NSE_DATA = "insert into wealthmanager.StockMaster(exchange, symbol,name, isinNumber, faceValue, listingDate, key) values (:exchange, :symbol, :name, :isinNumber, :faceValue, :listingDate, :key) on conflict(exchange, symbol) do nothing ";
