...
public interface SqlConstant {
	...
	public static final String UPDATE_STOCKPRICEMASTER = "insert into  StockPriceMaster (stockMasterId, stockKey, price, priceTime, priceTimeZone ) values (:stockMasterId , :stockKey , :price , :priceTime ,:priceTimeZone)";
